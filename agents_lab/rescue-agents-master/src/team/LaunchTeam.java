...
public final class LaunchTeam {
    ...
    */
    ...
    private static void connect(ComponentLauncher launcher, int fb, int pf, int at, Config config) throws InterruptedException, ConnectionException {
        ...
        try {
            while (true) {
                Logger.info("Connecting ambulance centre " + (i++) + "...");
        ...
        try {
            while (true) {
                Logger.info("Connecting police station centre " + (i++) + "...");
                launcher.connect(new PoliceStationCentre());
                Logger.info("success");
            }
        }
        catch (ComponentConnectionException e) {
        ...
        try {
            while (true) {
                Logger.info("Connecting fire station centre " + (i++) + "...");
                launcher.connect(new FireStationCentre());
                Logger.info("success");
            }
        }
        catch (ComponentConnectionException e) {
